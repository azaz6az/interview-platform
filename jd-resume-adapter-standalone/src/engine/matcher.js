...
/**
 * 计算总体匹配度分数
 * @param {Object} jdKeywords - JD 提取的关键词 { techKeywords, softSkillKeywords, dataKeywords, experienceKeywords, allKeywords }
 * @param {Object} resumeKeywords - 简历提取的关键词 { techKeywords, softSkillKeywords, dataKeywords, experienceKeywords, allKeywords }
 ...
 * @param {string[]} listA
 * @param {string[]} listB
 * @returns {string[]} 交集（保留 listA 中的原始大小写）
 */
...
/**
 * 找 listA 中有但 listB 中没有的（差集，不区分大小写）
 * @param {string[]} listA
 * @param {string[]} listB
 * @returns {string[]} 差集（保留 listA 中的原始大小写）
 */
